...
const { authenticateGoogleUser } = require('../../src/services/user.service');
...
describe('Auth routes', () => {
  describe('POST /v1/auth/register', () => {
    ...
    beforeEach(() => {
      newUser = {
        ...
        password: 'password1',
        subscriptionPlanId: faker.random.number(),
      };
    });
  ...
  describe('POST /v1/auth/login', () => {
    test('should return 200 and login user if email and password match', async () => {
      await insertUsers([{ ...userOne, emailVerified: true }]);
  ...
  describe('POST /v1/auth/google', () => {
    authenticateGoogleUser.mockImplementation(() => {
      return userOne;
    });

    test('should return 200 and login user if token verified', async () => {
      await insertUsers([{ ...userOne, emailVerified: true }]);
      const loginCredentials = {
